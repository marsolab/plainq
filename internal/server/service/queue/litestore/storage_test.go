...
func TestTursoCompatibleTopicConflictAndConnectionFailure(t *testing.T) {
	...
	_, err := conflictStorage.CreateTopic(context.Background(), &queueservice.CreateTopicRequest{TopicName: "events"})
	...
	_, err = unavailableStorage.CreateTopic(context.Background(), &queueservice.CreateTopicRequest{TopicName: "events"})
