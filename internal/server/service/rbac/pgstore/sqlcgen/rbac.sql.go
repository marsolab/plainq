...
func (q *Queries) AssignRoleToUser(ctx context.Context, arg AssignRoleToUserParams) (int64, error) {
	result, err := q.db.Exec(ctx, assignRoleToUser, arg.UserID, arg.RoleID, arg.CreatedAt)
	if err != nil {
		return 0, err
	}
...
func (q *Queries) BumpUserAuthVersion(ctx context.Context, userID string) (int64, error) {
	result, err := q.db.Exec(ctx, bumpUserAuthVersion, userID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) CountUsersPerRole(ctx context.Context) ([]CountUsersPerRoleRow, error) {
	rows, err := q.db.Query(ctx, countUsersPerRole)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) DeleteRoleQueuePermissions(ctx context.Context, roleID string) (int64, error) {
	result, err := q.db.Exec(ctx, deleteRoleQueuePermissions, roleID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) HasQueueDeletePermission(ctx context.Context, arg HasQueueDeletePermissionParams) (int64, error) {
	row := q.db.QueryRow(ctx, hasQueueDeletePermission, arg.QueueID, arg.UserID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) HasQueuePurgePermission(ctx context.Context, arg HasQueuePurgePermissionParams) (int64, error) {
	row := q.db.QueryRow(ctx, hasQueuePurgePermission, arg.QueueID, arg.UserID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) HasQueueReceivePermission(ctx context.Context, arg HasQueueReceivePermissionParams) (int64, error) {
	row := q.db.QueryRow(ctx, hasQueueReceivePermission, arg.QueueID, arg.UserID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) HasQueueSendPermission(ctx context.Context, arg HasQueueSendPermissionParams) (int64, error) {
	row := q.db.QueryRow(ctx, hasQueueSendPermission, arg.QueueID, arg.UserID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) RemoveRoleFromUserUnlessLastHolder(ctx context.Context, arg RemoveRoleFromUserUnlessLastHolderParams) (int64, error) {
	result, err := q.db.Exec(ctx, removeRoleFromUserUnlessLastHolder, arg.UserID, arg.RoleID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
